...
import 'package:firebase_calendar/screens/edit_event.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  hashCode: getHashCode,
    ...
    _firstDay = DateTime.now().subtract(const Duration(days: 999));
    _lastDay = DateTime.now().add(const Duration(days: 999));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Calendário Firebase'),
        centerTitle: true,
      ),
      body: ListView(
        children: [
          TableCalendar(
            ...
            headerStyle: const HeaderStyle(
                titleCentered: true, titleTextStyle: TextStyle(fontSize: 24)),
